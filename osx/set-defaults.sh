...
# sudo scutil --set ComputerName "Edvinas Mac"
# sudo scutil --set HostName "Edvinas Mac"
# sudo scutil --set LocalHostName "Edvinas Mac"
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Edvinas-Mac"
